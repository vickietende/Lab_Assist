...
{
    public partial class ToRCH : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10010";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
                ...
                if (txtToxoIgM.Text == "")
                {
                    ...
                    string script = "alert(\"Toxoplasma IgM result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtToxoIgG.Text == "")
                {
                    ...
                    string script = "alert(\"Toxoplasma IgG result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtCytoIgM.Text == "")
                {
                    ...
                    string script = "alert(\"Cytomegalovirus IgM result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtCytoIgG.Text == "")
                {
                    ...
                    string script = "alert(\"Cytomegalovirus IgG result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtRubIgM.Text == "")
                {
                    ...
                    string script = "alert(\"Rubella IgM result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtRubIgG.Text == "")
                {
                    ...
                    string script = "alert(\"Rubella IgG result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtHSVIIgM.Text == "")
                {
                    ...
                    string script = "alert(\"HSV I IgM result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtHSVIIgG.Text == "")
                {
                    ...
                    string script = "alert(\"HSV I IgG result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtHSVIIIgM.Text == "")
                {
                    ...
                    string script = "alert(\"HSV II IgM result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
                ...
                if (txtHSVIIIgG.Text == "")
                {
                    ...
                    string script = "alert(\"HSV II IgG result is required!!\");";
                    ScriptManager.RegisterStartupScript(this, GetType(),
                                          "ServerControlScript", script, true);
                    return;
            ...
            try
                {
                    ...
                    con.Open();
                    SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveToRCHResults]", con);
                    ...
                    cmd.Parameters.AddWithValue("@ToxoIgM", txtToxoIgM.Text);
                    cmd.Parameters.AddWithValue("@ToxoIgG", txtToxoIgG.Text);
                    cmd.Parameters.AddWithValue("@CytoIgM", txtCytoIgM.Text);
                    cmd.Parameters.AddWithValue("@CytoIgG", txtCytoIgG.Text);
                    cmd.Parameters.AddWithValue("@RubellaIgM", txtRubIgM.Text);
                    cmd.Parameters.AddWithValue("@RubellaIgG", txtRubIgG.Text);
                    cmd.Parameters.AddWithValue("@HSVIIgM", txtHSVIIgM.Text);
                    cmd.Parameters.AddWithValue("@HSVIIgG", txtHSVIIgG.Text);
                    cmd.Parameters.AddWithValue("@HSVIIIgM", txtHSVIIIgM.Text);
                    cmd.Parameters.AddWithValue("@HSVIIIgG", txtHSVIIIgG.Text);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/ToRCHResultsTemplate.docx"));
                    ...
                    filnameTemplate.ReplaceText("[TOXOIgM]", o_Result.ToxoplasmaIgM);
                    filnameTemplate.ReplaceText("[TOXOIgG]", o_Result.ToxoplasmaIgG);
                    filnameTemplate.ReplaceText("[CYTOIgM]", o_Result.CytomegalovirusIgM);
                    filnameTemplate.ReplaceText("[CYTOIgG]", o_Result.CytomegalovirusIgG);
                    filnameTemplate.ReplaceText("[RUBIgM]", o_Result.Rubella_IgM);
                    filnameTemplate.ReplaceText("[RUBIgG]", o_Result.Rubella_IgG);
                    filnameTemplate.ReplaceText("[HSVIIgM]", o_Result.HerpesSimplex1HSV1_IgM);
                    filnameTemplate.ReplaceText("[HSVIIgG]", o_Result.HerpesSimplex1HSV1_IgG);
                    filnameTemplate.ReplaceText("[HSVIIIgM]", o_Result.HerpesSimplex2HSV2_IgM);
                    filnameTemplate.ReplaceText("[HSVIIIgG]", o_Result.HerpesSimplex2HSV2_IgG);
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.ToxoplasmaIgM,o_Result.ToxoplasmaIgG,o_Result.CytomegalovirusIgM,o_Result.CytomegalovirusIgG,o_Result.Rubella_IgM,o_Result.Rubella_IgG,o_Result.HerpesSimplex1HSV1_IgM,o_Result.HerpesSimplex1HSV1_IgG,o_Result.HerpesSimplex2HSV2_IgM,o_Result.HerpesSimplex2HSV2_IgG, o_Result.DateReceived);
        ...
        public void getPatientData(string labno, string prodid)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    o_Result.ToxoplasmaIgM = dt.Rows[0]["ToxoplasmaIgM"].ToString();
                    o_Result.ToxoplasmaIgG = dt.Rows[0]["ToxoplasmaIgG"].ToString();
                    o_Result.CytomegalovirusIgM = dt.Rows[0]["CytomegalovirusIgM"].ToString();
                    o_Result.CytomegalovirusIgG = dt.Rows[0]["CytomegalovirusIgG"].ToString();
                    o_Result.Rubella_IgM = dt.Rows[0]["Rubella_IgM"].ToString();
                    o_Result.Rubella_IgG = dt.Rows[0]["Rubella_IgG"].ToString();
                    o_Result.HerpesSimplex1HSV1_IgM = dt.Rows[0]["HerpesSimplex1HSV1_IgM"].ToString();
                    o_Result.HerpesSimplex1HSV1_IgG = dt.Rows[0]["HerpesSimplex1HSV1_IgG"].ToString();
                    o_Result.HerpesSimplex2HSV2_IgM = dt.Rows[0]["HerpesSimplex2HSV2_IgM"].ToString();
                    o_Result.HerpesSimplex2HSV2_IgG = dt.Rows[0]["HerpesSimplex2HSV2_IgG"].ToString();
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult,string testresult2,string testresult3,string testresult4,string testresult5,string testresult6,string testresult7,string testresult8,string testresult9,string testresult10, string date)
        {
            try
            {
                var writer = new BarcodeWriter();
                writer.Format = BarcodeFormat.QR_CODE;
                var result = writer.Write("Full Name: " + name + "\n" + "IDNO: " + "\n" + idno + "\n" + " LabNo: " + labno + "--" + " Toxoplasma IgM: " + testresult + "   ToxoplasmaIgG:"+ testresult2 + "  Cyto IgM:"+ testresult3+ "  CytoIgG:"+ testresult4 + " RubellaIgM:"+ testresult5+  "  RubellaIgG:"+  testresult6 + "  HSVIIgM:"+ testresult7+ "  HSVIIgG:"+ testresult8+ "  HSVIIIgM:"+ testresult9+ "  HSVIIIgG:"+  testresult10 +" Date: " + date);
