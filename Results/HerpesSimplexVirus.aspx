<%@ Page Title="" Language="C#" MasterPageFile="~/Results/Site2.Master" AutoEventWireup="true" CodeBehind="HerpesSimplexVirus.aspx.cs" Inherits="Lab_Assist.Results.HerpesSimplexVirus" %>
<%@ Register
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:Panel ID="pnlContent" runat="server" BorderColor="SkyBlue" BorderWidth="1px"  CssClass="alert-dark">
       ...
       <h4>Herpes Simplex Virus I & II Results</h4>
          </div>
       ...
       <h4>Results</h4>
          ...
          <div class="container">
           ...
           <div class="container">
              <div class="row  mt-1">
                   <div class="col-md-6">
                       <asp:Label ID="Label21" runat="server" Text="Herpes Simplex I(HSV I)" Font-Bold="true" CssClass="control-label" ></asp:Label> 
          ...
          <div class="container">
           ...
           <div class="container">
              <div class="row  mt-1">
                   <div class="col-md-6">
                       <asp:Label ID="Label9" runat="server" Text="Herpes Simplex II(HSV II)" Font-Bold="true" CssClass="control-label" ></asp:Label> 
