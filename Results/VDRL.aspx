<%@ Page Title="" Language="C#" MasterPageFile="~/Results/Site2.Master" AutoEventWireup="true" CodeBehind="VDRL.aspx.cs" Inherits="Lab_Assist.Results.VDRL" %>
<%@ Register
       ...
       <h4>Results</h4>
           ...
           <div class="container">
            ...
            <div class="container">
              ...
              <div class="row  mt-1">
                    <div class="col-md-1">
                       <asp:Label ID="Label7" runat="server" Text="TPHA" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtTPHA" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
                       
                    </div>
                     <div class="col-md-1">
                       <asp:Label ID="Label8" runat="server" Text="RPR" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtRPR" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
