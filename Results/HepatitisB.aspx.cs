...
{
    public partial class HepatitisB : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10003";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtHbsAg.Text == "")
            {
                ...
                string script = "alert(\"HbsAg is required!!\");";
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
                return;
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveHepatitisBResults]", con);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/HepatitisBResultsTemplate.docx"));
                    ...
                    filnameTemplate.ReplaceText("[HbsAg]", o_Result.HbsAg);
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.HbsAg, o_Result.DateReceived);
        ...
        public void getPatientData(string labno, string prodid)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    o_Result.HbsAg = dt.Rows[0]["HbsAg"].ToString();
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult, string date)
        {
            try
            {
                ...
                var result = writer.Write("Full Name: " + name + "\n" + "IDNO: " + "\n" + idno + "\n" + " LabNo: " + labno + "--" + " HbsAg: " + testresult + " Date: " + date);
