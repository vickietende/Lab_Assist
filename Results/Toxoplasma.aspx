<%@ Page Title="" Language="C#" MasterPageFile="~/Results/Site2.Master" AutoEventWireup="true" CodeBehind="Toxoplasma.aspx.cs" Inherits="Lab_Assist.Results.Toxoplasma" %>
<%@ Register
       ...
       <h4>Results</h4>
          ...
          <div class="container">
            ...
            <div class="container">
              <div class="row  mt-1">
                    <div class="col-md-6">
                       <asp:Label ID="Label17" runat="server" Text="Toxoplasma IgM and IgG"  Font-Bold="true" Font-Size="Larger" CssClass="control-label" ></asp:Label> 
