<%@ Page Title="" Language="C#" MasterPageFile="~/Results/Site2.Master" AutoEventWireup="true" CodeBehind="HIV_ViralLoad.aspx.cs" Inherits="Lab_Assist.Results.HIV_ViralLoad" %>
<%@ Register
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
       ...
       <h4>Results</h4>
           ...
           <div class="container">
              <div class="row  mt-3">
                     <div class="col-md-1">
                       <asp:Label ID="Label13" runat="server" Text="Test" CssClass="control-label" ></asp:Label> 
            ...
            <div class="container">
              <div class="row  mt-1">
                    <div class="col-md-1">
                       <asp:Label ID="Label7" runat="server" Text="HIV RNA(<20)" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtHIVRNA" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
                       
                    </div>
                     <div class="col-md-1">
                       <asp:Label ID="Label8" runat="server" Text="Log Value" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtLogValue" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
