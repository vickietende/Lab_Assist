...
{
    public partial class HerpesSimplexVirus : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10006";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveHerpesSimplexVirusResults]", con);
                ...
                cmd.Parameters.AddWithValue("@HerpesSimplex1HSV1_IgM", txtHSVIIgM.Text);
                cmd.Parameters.AddWithValue("@HerpesSimplex1HSV1_IgG", txtHSVIIgG.Text);
                cmd.Parameters.AddWithValue("@HerpesSimplex2HSV2_IgM", txtHSVIIIgM.Text);
                cmd.Parameters.AddWithValue("@HerpesSimplex2HSV2_IgG", txtHSVIIIgG.Text);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/HerpesSimplexVirusResultsTemplate.docx"));
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.HerpesSimplex1HSV1_IgM,o_Result.HerpesSimplex1HSV1_IgG,o_Result.HerpesSimplex2HSV2_IgM,o_Result.HerpesSimplex2HSV2_IgG, o_Result.DateReceived);
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult,string testresult2,string testresult3,string testresult4, string date)
        {
            try
            {
                var writer = new BarcodeWriter();
                writer.Format = BarcodeFormat.QR_CODE;
                var result = writer.Write("Full Name: " + name + "\n" + "IDNO: " + "\n" + idno + "\n" + " LabNo: " + labno + "--" + " HSV I IgM: " + testresult +"  HSV I IgG:"+ testresult2 +"  HSV II IgM:"+ testresult3 +"  HSV II IgG"+ testresult4 +" Date: " + date);
