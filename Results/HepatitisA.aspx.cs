...
{
    public partial class HepatitisA : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10004";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtIgGAntibody.Text == "")
            {

                string script = "alert(\"IgG Antibody is required!!\");";
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
                return;

            }
            if (txtIgMAntibody.Text == "")
            {

                string script = "alert(\"IgM Antibody is required!!\");";
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
                return;
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveHepatitisAResults]", con);
                ...
                cmd.Parameters.AddWithValue("@IgGAntibody", txtIgGAntibody.Text);
                cmd.Parameters.AddWithValue("@IgMAntibody", txtIgMAntibody.Text);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/HepatitisAResultsTemplate.docx"));
                    ...
                    filnameTemplate.ReplaceText("[IgG]", o_Result.HepatitisAVirusIgGAntibody);
                    filnameTemplate.ReplaceText("[IgM]", o_Result.HepatitisAVirusIgMAntibody);
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.HepatitisAVirusIgGAntibody, o_Result.HepatitisAVirusIgMAntibody, o_Result.DateReceived);
        ...
        public void getPatientData(string labno, string prodid)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    o_Result.HepatitisAVirusIgGAntibody = dt.Rows[0]["HepatitisAVirusIgGAntibody"].ToString();
                    o_Result.HepatitisAVirusIgMAntibody= dt.Rows[0]["HepatitisAVirusIgMAntibody"].ToString();
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult,string testresult2, string date)
        {
            try
            {
                ...
                var result = writer.Write("Full Name: " + name + "\n" + "IDNO: " + "\n" + idno + "\n" + " LabNo: " + labno + "--" + " IgG Antibody: " + testresult +" IgM Antibody: "+ testresult2 + " Date: " + date);
