...
{
    public partial class Rubella : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10008";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveRubellaResults]", con);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/RubellaResultsTemplate.docx"));
                    ...
                    filnameTemplate.ReplaceText("[IgM]", o_Result.Rubella_IgM);
                    filnameTemplate.ReplaceText("[IgG]", o_Result.Rubella_IgG);
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.Rubella_IgM,o_Result.Rubella_IgG, o_Result.DateReceived);
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult, string testresult2, string date)
        {
            try
            {
                ...
                var result = writer.Write("Full Name: " + name + "\n" + "IDNO: " + "\n" + idno + "\n" + " LabNo: " + labno + "--" + " Rubella IgM: " + testresult + "    Rubella IgG:"+ testresult2 +"  Date: " + date);
