<%@ Page Title="" Language="C#" MasterPageFile="~/Results/Site2.Master" AutoEventWireup="true" CodeBehind="HIV.aspx.cs" Inherits="Lab_Assist.Results.HIV" %>
<%@ Register
   ...
   <div class="container">
       ...
       <h4>Results</h4>
          ...
          <div class="container">
              <div class="row  mt-1">
                    <div class="col-md-1">
                       <asp:Label ID="Label7" runat="server" Text="SD Bioline" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtSDBioline" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
                       
                    </div>
                     <div class="col-md-1">
                       <asp:Label ID="Label8" runat="server" Text="Abbot Determine" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtAbbotDetermine" autocomplete="off" CssClass="form-group"  runat="server" Width="200px" ></asp:TextBox>
                       
                    </div>
                    <div class="col-md-1">
                       <asp:Label ID="Label9" runat="server" Text="Final Result" CssClass="control-label" ></asp:Label> 
                        
                    </div>
                    <div class="col-md-3">
                <asp:TextBox   ID="txtFinalResult" autocomplete="off" CssClass="form-group"   runat="server" Width="200px" ></asp:TextBox>
