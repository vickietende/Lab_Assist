...
{
    public partial class HepatitisC : System.Web.UI.Page
    {
            ...
            try
            {
                ...
                using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["Constring"].ConnectionString))
                {
                    using (var cmd = new SqlCommand("Select * from [dbo].[tbl_Products]", con))
                    {
                        ...
                        ddl_Products.SelectedValue = "10005";
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (txtHepatitisCAntibody.Text == "")
            {

                string script = "alert(\"Hepatitis c Antibody result is required!!\");";
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
                return;

            }
            if (txtHepatitisCCoreAntigen.Text == "")
            {

                string script = "alert(\"Hepatitis C Core Antigen result is required!!\");";
                ScriptManager.RegisterStartupScript(this, GetType(),
                                      "ServerControlScript", script, true);
                return;
            ...
            try
            {
                ...
                con.Open();
                SqlCommand cmd = new SqlCommand("[dbo].[SP_SaveHepatitisCResults]", con);
                ...
                cmd.Parameters.AddWithValue("@HepatitiCAntibody", txtHepatitisCAntibody.Text);
                cmd.Parameters.AddWithValue("@HepatitisCCoreAntigen", txtHepatitisCCoreAntigen.Text);
        ...
        protected void createResultDoc(string labno, string prodid)
        {
            try
            {
                if (labno != "" & prodid != "")
                {
                    ...
                    DocX filnameTemplate = DocX.Load(System.Web.Hosting.HostingEnvironment.MapPath("~/Templates/HepatitisCResultsTemplate.docx"));
                    ...
                    filnameTemplate.ReplaceText("[HCA]", o_Result.HepatitisCAntibody);
                    filnameTemplate.ReplaceText("[HCCA]", o_Result.HepatitisCCoreAntigen);
                    ...
                    generateQrCode(o_Result.FullName, o_Result.IDNO, o_Result.LabNumber, o_Result.HepatitisCAntibody,o_Result.HepatitisCCoreAntigen, o_Result.DateReceived);
        ...
        private void generateQrCode(string name, string idno, string labno, string testresult,string testresult2, string date)
        {
            try
            {
                ...
                var result = writer.Write("Full Name: " + name + "\n" + "  IDNO: " + "\n" + idno + "\n" + "  LabNo: " + labno + "--" + " Hepatitis C Antibody: " + testresult + "  Hepatitis C Core Antigen:"+ testresult2 +"  Date: " + date);
        ...
        private void ClearAll()
        {
            ...
            txtlabNo.Text = "";
            txtTestCode.Text = "";
            txtHepatitisCAntibody.Text = "";
            txtHepatitisCCoreAntigen.Text = "";
        ...
        public void getPatientData(string labno, string prodid)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    o_Result.HepatitisCAntibody = dt.Rows[0]["HepatitisCAntibody"].ToString();
                    o_Result.HepatitisCCoreAntigen = dt.Rows[0]["HepatitisCCoreAntigen"].ToString();
